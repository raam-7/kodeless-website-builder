...
`,
  ...
  <button class="edit-about-title">Edit About Us Title</button>
<button class="edit-about-subtitle">Edit About Us Subtitle</button>
<button class="edit-core-values">Edit Core Values</button>
<button class="edit-about-cta-title">Edit CTA Title</button>
<button class="edit-about-cta-description">Edit CTA Description</button>
<button class="edit-about-cta-button">Edit CTA Button Text</button>
...
<button class="edit-contact-description">Edit Contact Description</button>
<button class="edit-contact-placeholders">Edit Form Placeholders</button>
<button class="edit-contact-button">Edit Submit Button Text</button>
<button class="edit-contact-bg">Change Background Color</button>
<button class="edit-contact-text-color">Change Text Color</button>
...
<div class="component p-4 rounded relative" style="margin-top: 20px;">
         <button class="remove-btn" style="position: absolute; top: 8px; right: 8px; background-color: red; color: white; padding: 4px 8px; border-radius: 4px; font-size: 14px;">X</button>
      <button class="edit-testimonial-title">Edit Testimonial Title</button>
<button class="edit-testimonial">Edit a Testimonial</button>
<button class="add-testimonial">Add New Testimonial</button>
<button class="edit-testimonial-bg">Change Background Color</button>
<button class="edit-testimonial-text-color">Change Text Color</button>
...
<div class="component p-4 rounded relative" style="margin-top: 20px;">
<button class="remove-btn" style="position: absolute; top: 8px; right: 8px; background-color: red; color: white; padding: 4px 8px; border-radius: 4px; font-size: 14px;">X</button>
<button class="edit-login-title">Edit Login Title</button>
<button class="edit-login-placeholders">Edit Input Placeholders</button>
<button class="edit-login-button">Edit Submit Button</button>
<button class="edit-login-bg">Change Background Color</button>
<button class="edit-login-text-color">Change Text Color</button>
